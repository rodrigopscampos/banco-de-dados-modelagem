...
insert into cursos (id, nome) values (2, 'C# - Fundamentos');

insert into professores (id, nome, documento, email) values (1, 'Rodrigo Campos', '11111111111', 'rodrigo.campos@sp.senai.br');
insert into professores (id, nome, documento, email) values (2, 'Wilson', '11111111112', 'wilson@sp.senai.br');

insert into alunos (id, nome, documento, email) values (1, 'João da Silva', '11111111112', null);
insert into alunos (id, nome, documento, email) values (2, 'Felpe Santos', '11111111113', null);
insert into alunos (nome, documento, email) values ('André Nascimento', '11111111114', null);
insert into alunos (nome, documento, email) values ('Biando de Souza', '11111111115', null);

insert into turmas (dt_inicio, dt_fim, duracao, cursos_id, professor_id) values ('2018-01-01', '2018-02-01', '20:00:00', 1, 1);
insert into turmas (dt_inicio, dt_fim, duracao, cursos_id, professor_id) values ('2018-03-01', '2018-04-01', '20:00:00', 1, 2);
